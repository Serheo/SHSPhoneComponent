...
- (void)testShouldDetectSpecificFormats
{
    ...
    result = [formatter configValuesForString:specififcInputNumber];
...
//    NSDictionary *result;
//    
//    result = [formatter configValuesForString:@"+7 (123"];
//    XCTAssertTrue([result[@"text"] isEqualToString:@"+78 (123"], @"should format correctly");
//    XCTAssertTrue(result[@"image"] == [NSNull null], @"image should be nil");
//    
//    result = [formatter configValuesForString:@"+87 (1234"];
